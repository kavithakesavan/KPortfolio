  ...
  return (
    <div class="w-full min-h-screen justify-center items-center ">
      <div class="flex flex-col justify-center items-center py-5 md:py-5 px-4 md:px-10 md:py-10 gap-4">
        ...
        <div class="flex flex-col gap-4 py-10 px-5 mt-8 md:px-7 rounded-lg border border-lime-800 hover:border-lime-600 duration-500 font-khula leading-relaxed text-lg font-semibold ">
          {listItems}
        </div>
      </div>
    </div>
