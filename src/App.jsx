        ...
        <div class="overflow-hidden max-w-screen flex justify-between items-center p-4 px-8 lg:px-24">
          ...
          <div class=" hidden md:flex justify-center items-center list-none gap-10 ml-50">
            <li class="hover:text-cyan-400 text-xl font-semibold duration-500 cursor-pointer">
              <a onClick={handlescroll} className="techstack">
                TechStack
              </a>
            </li>
            <li class="hover:text-cyan-400 text-xl font-semibold duration-500 cursor-pointer">
              <a onClick={handlescroll} className="highlights">
                Highlights
              </a>
            </li>
            <li class="hover:text-cyan-400 text-xl font-semibold duration-500 cursor-pointer">
              <a onClick={handlescroll} className="projects">
                Projects
              </a>
            </li>
            <li class="hover:text-cyan-400 text-xl font-semibold duration-500 cursor-pointer">
            ...
            <li class="hover:text-cyan-400 text-xl font-semibold duration-500 cursor-pointer">
              <a
                href="https://1drv.ms/b/c/c9649fe8d2d63852/ER_YCBf3USJCj3rf1sD8WmsBtCYytFseTYjka0wVs-mtlA?e=tfaCL4"
                target="_blank"
              >
                Resume
      ...
      <footer className="order-last block mb-5 text-sm text-center">
        <div className="flex flex-col justify-center items-center">
          <div class="flex justify-center items-center gap-3">
            <a
              class="ml-4 md:mx-5 hover:text-cyan-400 text-2xl"
              href="https://github.com/kavithakesavan"
              target="_blank"
            >
              <svg
                stroke="currentColor"
            ...
            <a
              class="ml-4 md:mx-5 hover:text-cyan-400 text-2xl"
              href="https://www.linkedin.com/in/kavitha-kesavan-b2671967/"
              target="_blank"
            >
              <svg
                stroke="currentColor"
            ...
            <a
              class="ml-4 md:mx-5 hover:text-cyan-400 text-2xl"
              href="https://x.com/kavithakesavan"
              target="_blank"
            >
              <svg
                stroke="currentColor"
            ...
            <a
              class="ml-4 md:mx-5 hover:text-cyan-400 text-2xl"
              href="https://www.facebook.com/kavitha.kesavan.98/"
              target="_blank"
            >
              <svg
                stroke="currentColor"
            ...
            <a
              class="ml-4 md:mx-5 hover:text-cyan-400 text-2xl"
              href="https://www.instagram.com/kavithakesavan89/"
              target="_blank"
            >
              <svg
                stroke="currentColor"
          ...
          <a
            href="https://github.com/kavithakesavan/KPortfolio"
            className="hover:text-link-color pt-5"
            target="_blank"
          >
